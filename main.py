...
def simulate_mycelium_network(G, num_iterations=100, vec_size=10):
    ...
    for iteration in range(num_iterations):
        ...
        # Backward pass: each node adjusts its weights.
        # In this simple example, we’ll use a self-supervised loss that nudges the output toward a target vector.
        loss_total = 0.0
        for node in G.nodes:
            ...
            # Calculate a mean-squared error loss.
        ...
        avg_loss = loss_total / G.number_of_nodes()
